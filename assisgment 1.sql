...
-- Q .1 = foriegn key and primary key
show tables;

describe actor;
-- actor_id is primary key and last_name is foriegn key

describe actor_award;
-- actor_id is primary key and last_name is foriegn key

describe address;
-- address_id is primary key and city_id is foriegn key
...
describe city;
-- city_id is primary ket and country_id is foriegn key
...
describe film;
-- film_id is primary key and title,language_id, original_language_id, rental_duration is foriegn key

describe film_actor;
-- actor_id, film_id is primary key

describe film_category;
-- film_id , category_id is primary key 

describe film_text;
-- film_id, tittle is primary key
